package com.example.newapp.ui.newtaxidriver.common.configs

import android.content.SharedPreferences
import com.example.newapp.ui.newtaxidriver.common.network.AppController
...
class SessionManager {
    ...
    var firebaseCustomToken: String?
        ...
        set(firebaseCustomToken) = sharedPreferences.edit()
            .putString("firebaseCustomToken", firebaseCustomToken).apply()

    var isFirebaseTokenUpdated: Boolean
        get() = sharedPreferences.getBoolean("isFirebaseTokenUpdated", false)
        set(isFirebaseTokenUpdated) = sharedPreferences.edit()
            .putBoolean("isFirebaseTokenUpdated", isFirebaseTokenUpdated).apply()

    var googleMapKey: String?
        get() = sharedPreferences.getString("google_map_key", "")
        set(google_map_key) = sharedPreferences.edit().putString("google_map_key", google_map_key)
            .apply()
    ...
    var driverSignupStatus: String?
        ...
        set(access_token) = sharedPreferences.edit().putString("driversignupstatus", access_token)
            .apply()
    ...
    var totalDistanceEverySec: Float
        ...
        set(totalDistanceEvery10Sec) = sharedPreferences.edit()
            .putFloat("totalDistanceEverySec", totalDistanceEvery10Sec).apply()
    ...
    var countryCurrencyType: String?
        ...
        set(setCountryCurrencyType) = sharedPreferences.edit()
            .putString("setCountryCurrencyType", setCountryCurrencyType).apply()
    ...
    var temporaryPhonenumber: String?
        ...
        set(phoneNumber) = sharedPreferences.edit().putString("TemporaryPhonenumber", phoneNumber)
            .apply()

    var temporaryCountryCode: String?
        get() = sharedPreferences.getString("TemporaryCountryCode", "")
        set(countryCode) = sharedPreferences.edit().putString("TemporaryCountryCode", countryCode)
            .apply()
    ...
    var isDriverAndRiderAbleToChat: Boolean
        ...
        set(status) = sharedPreferences.edit().putBoolean("setDriverAndRiderAbleToChat", status)
            .apply()


    var subTripStatus: String?
        get() = sharedPreferences.getString("SubTripStatus", "")
        set(SubTripStatus) = sharedPreferences.edit().putString("SubTripStatus", SubTripStatus)
            .apply()
    ...
    var currencySymbol: String?
        ...
        set(currencySymbol) = sharedPreferences.edit().putString("currencysymbol", currencySymbol)
            .apply()
    ...
    var profileDetail: String?
        ...
        set(profilearratdetail) = sharedPreferences.edit()
            .putString("profilearratdetail", profilearratdetail).apply()


    var paymentMethodkey: String
        get() = sharedPreferences.getString("paymentMethodkey", "").toString()
        set(paymentMethodkey) = sharedPreferences.edit()
            .putString("paymentMethodkey", paymentMethodkey).apply()


    var paymentMethod: String?
        get() = sharedPreferences.getString("paymentMethod", "")
        set(paymentMethod) = sharedPreferences.edit().putString("paymentMethod", paymentMethod)
            .apply()

    var paymentMethodImage: String
        get() = sharedPreferences.getString("paymentMethodImage", "").toString()
        set(paymentMethodImage) = sharedPreferences.edit()
            .putString("paymentMethodImage", paymentMethodImage).apply()
    ...
    var driverReferral: String?
        ...
        set(driverReferral) = sharedPreferences.edit().putString("driverReferral", driverReferral)
            .apply()
    ...
    var countryName2: String?
        ...
        set(currencyName2) = sharedPreferences.edit().putString("countryname2", currencyName2)
            .apply()
    ...
    var currencyName2: String?
        ...
        set(currencyName2) = sharedPreferences.edit().putString("currencyname2", currencyName2)
            .apply()

    var stripeCountryCode: String?
        get() = sharedPreferences.getString("StripeCountryCode", "")
        set(stripeCountryCode) = sharedPreferences.edit()
            .putString("StripeCountryCode", stripeCountryCode).apply()

    var payPalCountryCode: String?
        get() = sharedPreferences.getString("paypalcountrycode", "")
        set(payPalCountryCode) = sharedPreferences.edit()
            .putString("paypalcountrycode", payPalCountryCode).apply()
    ...
    var dialogMessage: String?
        ...
        set(DialogMessage) = sharedPreferences.edit().putString("DialogMessage", DialogMessage)
            .apply()
    ...
    var offlineDistance: Float
        ...
        set(offlineDistance) = sharedPreferences.edit()
            .putFloat("offline_distance", offlineDistance).apply()

    var onlineDistance: Float
        get() = sharedPreferences.getFloat("online_distance", 0f)
        set(onlineDistance) = sharedPreferences.edit().putFloat("online_distance", onlineDistance)
            .apply()
    ...
    var brainTreeClientToken: String?
        ...
        set(BrainTreeClientToken) = sharedPreferences.edit()
            .putString("BrainTreeClientToken", BrainTreeClientToken).apply()
    ...
    var stripePublishKey: String
        ...
        set(stripePublishKey) = sharedPreferences.edit()
            .putString("StripePublishKey", stripePublishKey).apply()
    ...
    var paypal_app_id: String
        ...
        set(paypal_app_id) = sharedPreferences.edit().putString("paypal_app_id", paypal_app_id)
            .apply()

    var braintree_public_key: String
        get() = sharedPreferences.getString("braintree_public_key", "").toString()
        set(braintree_public_key) = sharedPreferences.edit()
            .putString("braintree_public_key", braintree_public_key).apply()

    var braintree_env: String
        get() = sharedPreferences.getString("braintree_env", "").toString()
        set(braintree_env) = sharedPreferences.edit().putString("braintree_env", braintree_env)
            .apply()
    ...
    var isEndTripCalled: Boolean
        ...
        set(isEndTripCalled) = sharedPreferences.edit()
            .putBoolean("isEndTripCalled", isEndTripCalled).apply()

    var payementModeWebView: Boolean?
        get() = sharedPreferences.getBoolean("payementModeWebView", false)
        set(payementModeWebView) = sharedPreferences.edit()
            .putBoolean("payementModeWebView", payementModeWebView!!).apply()

    var isGeoFireUpdatedWhenOnline: Boolean?
        get() = sharedPreferences.getBoolean("isGeoFireUpdatedWhenOnline", false)
        set(isGeoFireUpdatedWhenOnline) = sharedPreferences.edit()
            .putBoolean("isGeoFireUpdatedWhenOnline", isGeoFireUpdatedWhenOnline!!).apply()

    var isLocationUpdatedForOneTime: Boolean?
        get() = sharedPreferences.getBoolean("isLocationUpdatedForOneTime", false)
        set(isLocationUpdatedForOneTime) = sharedPreferences.edit()
            .putBoolean("isLocationUpdatedForOneTime", isLocationUpdatedForOneTime!!).apply()

    var notificationID: String
        get() = sharedPreferences.getString("notificationID", "").toString()
        set(notificationID) = sharedPreferences.edit().putString("notificationID", notificationID)
            .apply()
